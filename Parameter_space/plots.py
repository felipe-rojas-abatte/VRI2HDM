...
bounds=np.linspace(-5,0,6,endpoint=True)
lim_inf = np.log10(0.00001)
lim_sup = np.log10(1)

bounds2=np.linspace(480,4500,20,endpoint=True)
lim_inf_Mh1 = 480
lim_sup_Mh1 = 4500
...
cax = ax.scatter(Mh1[cut], ld345[cut], c=np.log10(omega[cut]), cmap=cmap, vmin=lim_inf, vmax=lim_sup, s=dots, edgecolor='', rasterized=True)
...
plt.ylim(min(ld345),max(ld345))
fig.tight_layout()
plt.savefig(new_folder+'/Mh1_ld345_Omega_'+cuts+'.pdf')

# ---------- Plot 2 Mh1-Mh2-Omega --------------------------
fig2, ax2 = plt.subplots(figsize=(6,4))
cax2 = ax2.scatter(Mh1[cut], Mh2[cut], c=np.log10(omega[cut]), cmap=cmap, vmin=lim_inf, vmax =lim_sup, s=dots, edgecolor='', rasterized=True)
...
cax3 = ax3.scatter(Mh1[cut], Mhp[cut], c=np.log10(omega[cut]), cmap=cmap, vmin=lim_inf, vmax =lim_sup, s=dots, edgecolor='', rasterized=True)
...
cax4 = ax4.scatter(Mh2[cut], Mhp[cut], c=np.log10(omega[cut]), cmap=cmap, vmin=lim_inf, vmax =lim_sup, s=dots, edgecolor='', rasterized=True)
...
cax5 = ax5.scatter(Mh1[cut], a[cut], c=np.log10(omega[cut]), cmap=cmap, vmin=lim_inf, vmax =lim_sup, s=dots, edgecolor='', rasterized=True)
...
cax6 = ax6.scatter(Mh2[cut], a[cut], c=np.log10(omega[cut]), cmap=cmap, vmin=lim_inf, vmax =lim_sup, s=dots, edgecolor='', rasterized=True)
...
cax7 = ax7.scatter(Mhp[cut], RAA[cut], c=np.log10(omega[cut]), cmap=cmap, vmin=lim_inf, vmax =lim_sup, s=dots, edgecolor='', rasterized=True)
...
cax8 = ax8.scatter(Mh1[cut], MR[cut], c=np.log10(omega[cut]), cmap=cmap, vmin=lim_inf, vmax =lim_sup, s=dots, edgecolor='', rasterized=True)
